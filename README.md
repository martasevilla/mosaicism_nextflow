...
The nf-core/mosaicism pipeline comes with documentation about the pipeline [usage]("./docs/usage.md"), [parameters](https://nf-co.re/mosaicism/parameters) and [output](https://nf-co.re/mosaicism/output).
